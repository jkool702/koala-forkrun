...
printf '%s\n' \
    ...
    "mv src/liblzma/rangecoder/price_tablegen.c src/liblzma/rangecoder/price_tablegen.c.exclude" | frun -i {}
...
printf '%s\n' \
    ...
    "mv src/liblzma/rangecoder/price_tablegen.c.exclude src/liblzma/rangecoder/price_tablegen.c" | frun -i {}
